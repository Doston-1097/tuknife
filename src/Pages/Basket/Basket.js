  ...
  return (
        ...
        <>
            ...
            <Grid container sx={{display: 'inline'}} spacing={2}>
                <Grid item xs={8} md={6} sx={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                    <Box><Button onClick={() => goBack()} sx={{color: 'white !important'}}><CgArrowLongLeft/> Ortga</Button></Box>
                </Grid>
                <Typography component={'h3'} variant='h2' sx={{textAlign: 'center',mb:"50px",color: 'white !important'}}>Kорзина</Typography>
                            ...
                            return (
                                <Card key={id} sx={{
                                    ...
                                    <Box sx={{display: 'flex', alignItems: 'center',}}>
                                        ...
                                        />
                                        <CardContent sx={{display: 'flex',flexWrap:'wrap',minWidth:'200px', alignItems: 'center', gap: '20px',}}>
                                    ...
                                    <Box sx={{display: 'flex', alignItems: 'center', gap: '20px'}}>
                                        ...
                                        <Typography variant="body2" color="text.secondary" sx={{color: 'white !important'}}>
                                            {getItem.price * getItem.nums} so'm
                                        </Typography>
                                        <CardActions>
                ...
                <Grid container  sx={{display: 'flex', alignItems: 'center'}}>
                    <Grid item xs={12} md={12} lg={6} sx={{display: 'flex', alignItems: 'center', gap: '30px',color:"white !important",marginY:'30px'}}>
                        <Box sx={{
                            fontSize: '35px',
                            display: 'flex',
                ...
                <Grid   sx={{borderRadius: '15px', backgroundColor: '#232323', color: 'white',paddingY:'60px !important',paddingX: '40px !important'}}>
                    ...
                    <Grid container >
                        ...
                        <Grid item xs={12} md={6} lg={6} px={2}>
                            <Box>
                                <Typography sx={{paddingY: '20px'}}>Нажимая «Выбрать способ доставки», подтверждаю, что я ознакомлен с условиями
                                    <Typography sx={{color: '#C80000',display:'inline-block'}}>Публичного договора оферты</Typography> и <Typography sx={{color: '#C80000',display:'inline-block'}}>Политикой конфиденциальности</Typography>, а также согласен получать
                                    информационную рассылку</Typography>
                                <Button variant="contained" onClick={sendValue} sx={{color: 'white',backgroundColor:'#C80000',paddingY:'16px',paddingX:'34px',borderRadius:'27px','&:hover':{backgroundColor:'#C82000'}}}>Отправить форму</Button>
                            </Box>
                        </Grid>
                    </Grid>
                </Grid>
